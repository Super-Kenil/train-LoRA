# # AI Model training toolkit - Origin: AI Toolkit by Ostris

- Refer to my custom config I used from config/examples/train_lora_flux_my_photos_v1.yaml 

## Below readme origins from Ostris.
